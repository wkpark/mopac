...
C
      ...
      DO 550 K=1,MINPQ
         CK=COS(XNOW*THETA(K))
         SK=SIN(XNOW*THETA(K))
         IF(DEBUG)WRITE(6,'('' ROTATION ANGLE:'',F12.4)')SK*57.295779513082323D0
         DO 540 I=1,N
...
C
  ...
  570 VEC(I,J)=CP(I,J)
      MODE=2
  580 ROLD=XOLD*THETA(1)*57.295779513082323D0
      RNOW=XNOW*THETA(1)*57.295779513082323D0
      RMIN=XMIN*THETA(1)*57.295779513082323D0
