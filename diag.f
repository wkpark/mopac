...
C       ARE GENERATED BY IT ARE MORE NEARLY ABLE TO BLOCK-DIAGONALIZE
...
C           IS NOT DIAGONALIZED, ONLY THE OCCUPIED-VIRTUAL INTERSECTION.
...
C
            ...
            D=A-B
C
C    RESTRICT THE ANGLE OF ROTATION TO ABOUT  41.4 DEGREES
C    (THIS NUMBER WAS PICKED ARBITARILY, JJPS)
C
            E=MIN((C/D)**2,0.5D0)
            ALPHA=1.D0-E*0.5D0
