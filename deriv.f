...
************************************************************************
     ...
     1AIFRST, ISOK, GEOOK, INT, SLOW2
      DATA ICALCN /0/
      IF(ICALCN.NE.NUMCAL) THEN
         AIFRST= (INDEX(KEYWRD,'RESTART').EQ.0)
         DEBUG = (INDEX(KEYWRD,'DERIV') .NE. 0)
      PRECIS = (INDEX(KEYWRD,'PREC') +
     1         INDEX(KEYWRD,'AQUO') +
     2         INDEX(KEYWRD,'ENVAQ') .NE. 0)
...
C
  ...
  110 GNORM=GNORM+GRAD(I)**2
      ...
      ENDIF
      SLOW2=.FALSE.
      SLOW2 = ((INDEX(KEYWRD,'AQUO') +
     1         INDEX(KEYWRD,'ENVAQ') .NE. 0)
     2.AND. (INDEX(KEYWRD,'NOFUL').EQ.0))
      IF(SLOW2)THEN
         SLOW=.TRUE.
      ENDIF
